...
```
Set-SDPRequestWorklog [-RequestId] <Int64> [-Id] <Int64> [[-Description] <String>] [[-TechnicianName] <String>]
...
### EXAMPLE 1
```
Set-SDPRequestWorklog -RequestId 12345 -Id 67890 -TimeSpent 120 -Description 'Full disk replacement.'
```
