...
### List (Default)
```
Get-SDPRequestNote -RequestId <Int64> [-PageSize <Int32>] [-StartIndex <Int32>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPRequestNote -RequestId <Int64> -Id <Int64> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
