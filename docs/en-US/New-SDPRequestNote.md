...
```
New-SDPRequestNote [-RequestId] <Int64> [-Description] <String> [[-IsPublic] <Boolean>]
...
### -IsPublic
When true the note is visible to requesters.
Default false.
...
### -NotifyTechnician
When true an email notification is sent to the assigned technician.
Default false.
