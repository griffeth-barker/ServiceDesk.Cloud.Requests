...
### List (Default)
```
Get-SDPRequestTaskWorklog -RequestId <Int64> -TaskId <Int64> [-PageSize <Int32>] [-StartIndex <Int32>] [-All]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Id
```
Get-SDPRequestTaskWorklog -RequestId <Int64> -TaskId <Int64> -Id <Int64> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
### -PageSize
Number of worklogs to return per page.
Maximum 100.
Default 100.
